<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="<c:url value="#" />"><i class="fa fa-book fa-fw"></i> Forum<span class="fa arrow"></span></a>
			...
			<li><a href="<c:url value="#" />"><i class="fa fa-paperclip fa-fw"></i> Homework<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="<c:url value="/homework/" />"> View all</a></li>
					<li><a href="<c:url value="/homework/add/" />"> Add new</a></li>
				</ul>
			</li>
			<li><a href="<c:url value="#" />"><i class="fa fa-file-o fa-fw"></i> Notes<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">

			...
			<div class="row">
				<form method="post" action="find">
					...
					<select name="type">
						...
						<option value="findByFirstOrLastName">findByFirstOrLastName</option>
						<option value="findWithinNames">findWithinNames</option>
						...
						<option value="findByLastNameContainingOrFirstNameContainingIgnoreCase">findByLastNameContainingOrFirstNameContainingIgnoreCase</option>
						<option value="findAllByOrderByDayOfBirthTop10OrderByLastName">findByOrderByDayOfBirthTop10OrderByLastName</option>
